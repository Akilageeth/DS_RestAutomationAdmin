...
<body id="login">
	...
	<section id="content">
		...
		%>
		<form name="loginForm" method="post" action="private/dashboard.jsp"
			id="loginform">
			<fieldset>
				<section>
				...
				<section>
					<label for="password">Password <a href="#">lost
							password?</a></label>
					<div>
					...
					<div>
						<input type="checkbox" id="remember" name="remember"><label
							for="remember" class="checkbox">remember me</label>
					</div>
				</section>
				<section>
					<div>
						<button class="fr submit"
							onClick="javascript:document.loginForm.submit()" tabindex="3">Login</button>
					</div>
				</section>
			</fieldset>
		</form>
	</section>
	<footer>Copyright by NSBM 2019</footer>
