...
<section id="content">
	<div class="g12 nodrop">
		<h1>
			...
			<button
				onclick="window.location=href='add_ingredient.jsp#addingredients'"
				style="float: right">Insert Ingredient</button>
		</h1>
	</div>
		...
		<form>
			<fieldset>
				...
				<section>
					...
					<div>
						<select name="dropdownCategoryEdit" id="dropdownCategoryEdit"
							onchange="showHint(this.value,'selectDishes','suggestions/listDishesIngredient.jsp')">
				...
				<section>
					...
					<div id="selectDishes">
						<select name="dishID" id="dishID"
							onchange="showHint(this.value,'suggestIngredient','suggestions/ingredientSuggestions.jsp')">
							<option value="0">Select</option>
						</select>
					</div>
					<div id="suggestIngredient"
  ...
  {
  %>
		<form id="addingredients" name="addIngredient"
			action="actions/Ingredient.jsp" method="post">
			<fieldset>
   ...
   String action = request.getParameter("action");
				...
				<section>
					...
					<div>
						<select name="dropdownCategory" id="dropdownCategory"
							onchange="showHint(this.value,'listDishes','suggestions/listDishes.jsp')">
							<option value="0" selected="selected">Select</option>
							<% 
								for(Category var : suggestCat.suggestCategory(""))
								{
    ...
    {  
  %>
		<form id="editingredients" name="updateIngredient"
			action="actions/Ingredient.jsp" method="post">
			<fieldset>
      ...
      else if(action.equals("add_success"))
		{
			%>
				...
				<section>
					<label for="input">Ingredient Name</label>
					<div>
						<input type="text" id="input" name="ingredientName"
