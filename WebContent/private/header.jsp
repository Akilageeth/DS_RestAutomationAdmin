...
%>
	...
	<header>
	 <div id="logo">
			<a href="dashboard.jsp">Logo Here</a>
		</div>
		...
		<div id="header">
			<ul id="headernav">
				<li><ul>
						...
						<li><a href="feedback.jsp">Ratings</a><b id="feedbackCount"></b></li>
						<li><a href="call_waiter.jsp">Call RoomService</a><b
							id="callWaiterCount"></b></li>
