...
%>
	...
	<% ChartController controller = new ChartController();
		if(controller.getDailyChart() == null){
		%>
	<div class="g6 widgets">
		<div class="widget" id="widget_charts" data-icon="graph">
			...
			<div>
				...
				<p>
					<a class="btn" href="daily_sales_reports.jsp">See Complete
						Reports</a>
				</p>
			</div>
		</div>
	...
	<div class="g12">
		<div class="cpanel">
			<div class="icon-wrapper">
				<div class="icon">
					<a href="add_category.jsp"><img
						src="../css/imgicons/dish-icon.png" alt=""><span>Dish
							Management</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="new_orders.jsp"><img
						src="../css/imgicons/order-icon.png" alt=""><span>Order
							Management</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="add_message.jsp"><img
						src="../css/imgicons/greeting-icon.png" alt=""><span>Greeting
							Management</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="add_ads.jsp"><img src="../css/imgicons/ad-icon.png"
						alt=""><span>Ads Management</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="feedback.jsp"><img
						src="../css/imgicons/feedback-icon.png" alt=""><span>Feedback</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="#"><img src="../css/imgicons/report-icon.png" alt=""><span>Reports</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="user_Mgt.jsp"><img src="../css/imgicons/user-icon.png"
						alt=""><span>User Management</span></a>
				</div>
			</div>
			<div class="icon-wrapper">
				<div class="icon">
					<a href="tax_setting.jsp"><img
						src="../css/imgicons/settings-icon.png" alt=""><span>General
							Settings</span></a>
				</div>
			</div>
		</div>
