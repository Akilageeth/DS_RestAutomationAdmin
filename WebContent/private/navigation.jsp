...
<nav>
	...
	<ul id="nav">
		...
		<li class="i_book"><a><span>Food Management</span></a>
			<ul>
				<li><a href="add_category.jsp"><span>Category
							Management</span></a></li>

				<li><a href="add_dishes.jsp"><span>Dishes Management</span></a></li>

				<li><a href="add_ingredient.jsp"><span>Ingredients
							Management</span></a></li>
		...
		<li class="i_book"><a href="add_message.jsp"><span>Greeting
					Management</span></a></li>
		<li class="i_book"><a href="feedback.jsp"><span>Ratings</span></a></li>
		<li class="i_book"><a href="#"><span>Reports</span></a>
			<ul>
				<li><a href="daily_sales_reports.jsp"><span>Daily
							Sales Reports</span></a></li>
				<li><a href="monthly_sales_reports.jsp"><span>Monthly
							Sales Reports</span></a></li>
				<li><a href="most_sold_reports.jsp"><span>Sold
							Dishes</span></a></li>
				<li><a href="profit_reports.jsp"><span>Trend
							Report(Profitable)</span></a></li>
			</ul></li>
