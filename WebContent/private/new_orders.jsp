		...
		<form id="orderdetail">
			<fieldset>
			  ...
			  %>
				...
				<section>
					<button
						onclick="document.location.href = 'actions/Order.jsp?id=<%=detail.getID()%>&status=cancelled';">Cancel</button>
					<button
						onclick="document.location.href = 'actions/Order.jsp?id=<%=detail.getID()%>&status=confirmed';">Confirm</button>
				</section>
			</fieldset>
		</form>
		<%} %>
