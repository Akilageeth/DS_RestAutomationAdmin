...
<section id="content">
  ...
  {
  %>
		<form name="registerForm" action="actions/Register.jsp" method="post"
      ...
      else if(action.equals("add_success"))
		{
			%>
				...
				<section>
					<label for="file_upload">Image<br> <span>Employee
		...
		<% }else
    	{%>
		<form name="updateForm" action="actions/Register.jsp" method="post"
			enctype="multipart/form-data">
			<fieldset>
				<label>New User</label>
				<%  String action = request.getParameter("action");
      ...
      else if(action.equals("update_success"))
		{
			%>
				...
				<section>
					...
					<div>
						<input type="text" id="input" name="userName"
							value="<%=request.getParameter("username") %>" required>
					</div>
				</section>
				...
				<section>
					<label for="input">Password</label>
					<div>
						<input type="password" id="input" name="userPassword"
							value="<%=request.getParameter("pass") %>" required>
					</div>
				</section>
				<section>
					<label for="input">First Name</label>
					<div>
						<input type="text" id="input" name="userFirstName"
							value="<%=request.getParameter("firstname") %>" required>
					</div>
				</section>
				<section>
					<label for="input">Last Name</label>
					<div>
						<input type="text" id="input" name="userLastName"
							value="<%=request.getParameter("lastname") %>" required>
					</div>
				</section>
				<section>
					<label for="email">Email</label>
				...
				<section>
					<label for="input">Address</label>
					<div>
						<input type="text" id="input" name="userAddress"
				...
				<section>
					<label for="integer">Cnic</label>
					<div>
						<input type="text" name="userCnic" id="cnic"
							value="<%=request.getParameter("cnic") %>" required />
					</div>
				</section>
				<section>
					<label for="input">Telephone/Mobile</label>
					<div>
						<input type="text" name="userTele" id="tele"
							value="<%=request.getParameter("tele") %>" required />
					</div>
				</section>
				<section>
					<label for="file_upload">Image<br> <span>Employee
					...
					<div>
						<input type="file" id="file_upload" name="userImage">
						<div>
							<img border="2" src=../uploads
								/<%=request.getParameter("image") %> width="137" height="140" />
						</div>
					</div>
				</section>
				<section>
