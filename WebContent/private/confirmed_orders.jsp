	...
	<div class="g12">
		<form>
			<fieldset>
				...
				<div id="confirmOrders" style="overflow-y: scroll; height: 600px;">
					<jsp:include page="suggestions/getConfirmOrders.jsp">
						<jsp:param name="q" value="confirmed" />
			...
			<fieldset>
			  ...
			  %>
				...
				<section>
					...
					<button
						onclick="document.location.href = 'actions/Order.jsp?id=<%=detail.getID()%>&status=delivered';">Deliver</button>
				</section>
			</fieldset>
		</form>
		<%} %>
