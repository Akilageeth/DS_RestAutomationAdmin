	...
	<div class="g12">
		<form>
			<fieldset>
				...
				<div id="deliveredOrders" style="overflow-y: scroll; height: 600px;">
					<jsp:include page="suggestions/getDeliveredOrders.jsp">
						<jsp:param name="q" value="delivered" />
			...
			<fieldset>
			  ...
			  %>
									<tr>
										...
										<td><%=newOrderDishes.getDishPrice() %> $</td>
			  ...
			  %>
								...
								<p align="right" style="margin-right: 20px">
									<strong>Total Bill (Tax: <%=taxController.checkTax()%>%):
										<%=totalBill %> $
									</strong>
								</p>
							</td>
				...
				<section>
					...
					<button
						onclick="document.location.href = 'actions/Order.jsp?id=<%=detail.getID()%>&status=billed&bill_amount=<%=totalBill %>';">Paid</button>
				</section>
			</fieldset>
		</form>
		<%} %>
