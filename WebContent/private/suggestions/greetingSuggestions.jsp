...
<table class="documentation">
	...
	<tbody>
		...
		<tr>
			...
			<td><a
				href='add_message.jsp?id=<%= g.getGreetingId()%>#editmessage'>Edit</a></td>
			<td><button
					onclick="deleteRecord('<%=g.getGreetingId() %>','actions/<%=constant.getDeleteGreeting() %>','suggestGreeting');">Delete</button></td>
		</tr>
		<%
   		}
%>
